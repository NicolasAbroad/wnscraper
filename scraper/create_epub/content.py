...
# Creates start of content.opf string
def create_content(volume_title, author_name, uid):
...
# Adds one item id to content.opf string
def add_item_id(content_string, xhtml_name):
    content_string += '        <item id ="' + xhtml_name + '" href="' + xhtml_name +\
                      '.xhtml" media-type="application/xhtml+xml"/>\n'
    return content_string


# Finishes manifest section and starts spine section in content.opf string
def create_middle():
...
# Adds one itemref to content.opf string
def add_itemref(content_string, xhtml_name):
    content_string += '        <itemref idref ="' + xhtml_name + '"/>\n'
    return content_string


# Adds final lines to content.opf string and creates file
def finish_content(content_string, epub_file):
